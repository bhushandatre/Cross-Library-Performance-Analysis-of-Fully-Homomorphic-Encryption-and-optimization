...
class DifferentNumbersExperiment:
    def __init__(self):
        self.results = []
        self.experiment_name = "Different_Numbers_Experiment"
    ...
    def generate_different_numbers_data(self, vector_size, max_value=1000):
        """Generate test data with different random numbers in all slots"""
        arr1 = np.random.randint(1, max_value, size=vector_size, dtype=np.int64)
        arr2 = np.random.randint(1, max_value, size=vector_size, dtype=np.int64)
        
        print(f"    Using different random numbers in all {vector_size} slots")
        print(f"    Sample - Array1[0:5]: {arr1[:5]}, Array2[0:5]: {arr2[:5]}")
        return arr1, arr2
    ...
    def run_experiment(self):
        """Run the complete experiment for different numbers in all slots"""
        ...
        print(f"Testing DIFFERENT NUMBERS in all slots")
        ...
        for poly_degree in poly_modulus_degrees:
            ...
            for vector_size in vector_sizes:
                ...
                try:
                    ...
                    arr1, arr2 = self.generate_different_numbers_data(vector_size)
    ...
    def generate_summary(self):
        ...
        print(f"\n{'='*80}")
        print(f"EXPERIMENT SUMMARY - DIFFERENT NUMBERS IN ALL SLOTS")
        print(f"{'='*80}")
...
def main_different_numbers():
    """Main function to run the different numbers experiment"""
    experiment = DifferentNumbersExperiment()
    ...
    print("Different Numbers Experiment completed!")

if __name__ == "__main__":
    main_different_numbers()
